...
import HomeScreen from '../../screens/user_contents/HomeScreen';
import ProfileScreen from '../../screens/user_contents/ProfileScreen';
import MovieScreen from '../../screens/user_contents/MovieScreen';
import Branches from '../../screens/user_contents/Branches';
import TicketScreen from '../../screens/user_contents/TicketScreen';
    ...
    <Tab.Navigator
      ...
      <Tab.Screen
        ...
        options={{
          ...
          headerTitleStyle:{color: COLORS.white, fontSize: 20},
          headerTitle: () => (
          <Image style={{ width: 120, height: 90}} source={require("../../assets/header4.png")} />
          ),
          headerTitleAlign: 'center',
          headerRight: () => (
          <TouchableOpacity>
